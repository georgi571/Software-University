INSERT INTO preserves.continents (name)
VALUES ('Asia'),
       ('Africa'),
       ('North America'),
       ('South America'),
...
INSERT INTO preserves.countries (name, country_code, continent_id)
VALUES ('Greenland', 'GL', 3),
       ('Equador', 'EC', 4),
       ('USA', 'US', 3),
       ('Australia', 'AU', 7),
       ('Canada', 'CA', 3),
...
VALUES ('Parque Nacional Patagonia', -46.9412, -72.1649, 3045, 'Nature Reserve', '2018-01-29'),
...
INSERT INTO preserves.positions (id, name, description, is_dangerous)
VALUES (1, 'Botanist',
        'Studies plant life within the preserve, identifying species, assessing biodiversity, and monitoring for invasive plants that could disrupt the native ecosystem.',
        0),
       (2, 'Conservation Scientist',
        'Develops and implements plans to manage and protect natural resources. Focuses on sustainable practices to preserve the ecological balance.',
        0),
       (3, 'Ecologist',
        'Examines the relationships between organisms and their environment, studying how factors such as climate, terrain, and other species impact the ecosystem.',
        0),
       (4, 'Environmental Educator',
        'Designs and conducts educational programs for visitors, schools, and local communities to raise awareness about conservation, ecology, and sustainable practices.',
        0),
       (5, 'Fire Management Specialist',
        'Develops and implements controlled burn programs to maintain the health of certain ecosystems that depend on periodic fires',
        1),
       (6, 'Forester',
        'Manages the forested areas within the preserve, assessing tree health, planning timber harvests (if applicable), and implementing reforestation efforts.',
        0),
       (7, 'Land Steward',
        'Monitors and manages the land, ensuring that human activities do not harm the natural habitat. Implements land restoration projects and invasive species control.',
        0),
       (8, 'Park Ranger',
        'Responsibilities include enforcing park regulations, providing information to visitors, conducting educational programs, and overseeing the overall safety of the preserve.',
        1),
       (9, 'Research Scientist',
        'Conducts scientific research within the preserve, contributing to the broader scientific community\'s understanding of ecosystems, biodiversity, and conservation.',
        0),
       (10, 'Trail Maintenance Worker',
        'Responsible for constructing and maintaining trails within the preserve, ensuring they are safe for visitors while minimizing impact on the environment.',
        0),
       (11, 'Visitor Services Coordinator',
        'Manages visitor centers, coordinates events, and ensures positive visitor experiences while educating them about the preserve\'s ecosystems and rules.',
        1),
       (12, 'Wildlife Biologist',
        'Studies and monitors the wildlife population, behavior, and habitats. Conducts research to assess the health and biodiversity of the ecosystem.',
        0),
       (13, 'Wildlife Rehabilitator',
        'Works to rehabilitate injured or orphaned wildlife found within the preserve. Provides medical care and releases animals back into their natural habitat.',
        1),
       (14, 'GIS Specialist',
        'Uses GIS (Geographic Information System) technology to map and analyze the preserve\'s geography, habitats, and species distribution for better decision-making in conservation efforts.',
        0);


INSERT INTO preserves.workers (first_name, last_name, age, personal_number, salary, is_armed, preserve_id, position_id,
                     start_date)
VALUES ('Mia', 'Martinez', '41', '134938', '3700.75', '1', '5', '4', '2000-02-02'),
...
INSERT INTO preserves.countries_preserves (country_id, preserve_id)
VALUES (1, 2),
       (2, 4),
       (2, 8),
       (2, 9),
