INSERT INTO real_estate.cities (name)
VALUES ('London'),
       ('Paris'),
       ('Berlin'),
       ('Rome'),
       ...
       ('Amsterdam'),
       ('Plovdiv');
insert into real_estate.property_types (id, type, description)
values (1, 'Apartment',
...
insert into real_estate.properties (id, address, price, area, property_type_id, city_id)
...
insert into real_estate.agents (id, first_name, last_name, phone, email, city_id)
...
insert into real_estate.buyers (id, first_name, last_name, phone, email, city_id)
...
insert into real_estate.property_offers (property_id, agent_id, price, offer_datetime)
...
insert into real_estate.property_transactions (id, property_id, buyer_id, transaction_date, bank_name, iban, is_successful)
