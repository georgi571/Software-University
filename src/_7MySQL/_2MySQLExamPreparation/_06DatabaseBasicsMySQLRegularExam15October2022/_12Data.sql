insert into restaurant2.products (id, name, type, price)
...
insert into restaurant2.clients (id, first_name, last_name, birthdate, card, review)
...
insert into restaurant2.waiters (id, first_name, last_name, email, phone, salary)
...
insert into restaurant2.tables (id, floor, reserved, capacity)
values  (1, 2, 0, 6),
        (2, 1, 1, 10),
        (3, 3, 0, 6),
        (4, 1, 0, 9),
        ...
        (29, 1, 1, 5),
        (30, 1, 0, 12);
insert into restaurant2.orders (id, table_id, waiter_id, order_time, payed_status)
values  (3, 16, 1, '17:27:49', 0),
        ...
        (24, 3, 10, '06:15:05', 0),
        (8, 12, 10, '01:43:59', 0);
insert into restaurant2.orders_products (order_id, product_id)
values  (1, 1),
        (1, 4),
        (1, 33),
        (1, 53),
        ...
        (42, 130),
        (42, 131);
insert into restaurant2.orders_clients (order_id, client_id)
values  (1, 29),
        (1, 31),
        (1, 40),
        (1, 43),
