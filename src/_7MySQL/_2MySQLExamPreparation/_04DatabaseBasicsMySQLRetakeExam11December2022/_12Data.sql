insert into airlines.countries (name, currency, description)
...
insert into airlines.passengers (first_name, last_name, country_id)
values  ('Daniela', 'Paulot', 4),
        ...
        ('Kendal', 'Cusack', 33),
        ('Charla', 'Cooke', 30);
insert into airlines.flights (flight_code, departure_country, destination_country, airplane_id, has_delay, departure)
...
insert into airlines.flights_passengers (flight_id, passenger_id)
values  (1, 46),
        (1, 80),
        (1, 100),
        (2, 3),
