insert into softuni_taxi_company.addresses (`name`)
...
insert into softuni_taxi_company.categories (`name`)
values ('Hatchback'),
       ('Coupe'),
       ('Cabrio'),
       ('Sedan'),
...
insert into softuni_taxi_company.drivers (first_name, last_name, age, rating)
...
insert into softuni_taxi_company.cars (make, model, `year`, mileage, `condition`, category_id)
...
insert into softuni_taxi_company.courses (from_address_id, `start`, car_id, client_id, bill)
...
insert into softuni_taxi_company.cars_drivers (car_id, driver_id)
values (94, 4),
       (22, 33),
       (60, 26),
       (5, 12),
