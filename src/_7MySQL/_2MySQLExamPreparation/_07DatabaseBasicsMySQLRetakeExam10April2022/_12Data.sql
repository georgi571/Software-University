insert into softuni_imdbs.countries (`name`, `continent`, `currency`)
values ('Albania', 'Europe', 'ALL'),
       ...
       ('Iran', 'Asia', 'PKR'),
       ('Uzbekistan', 'Asia', 'UZS');
insert into softuni_imdbs.genres (name)
values ('Action'),
       ('Adventure'),
       ('Animation'),
       ('Biography'),
...
insert into softuni_imdbs.movies_additional_info (id, rating, runtime, picture_url, budget, release_date, has_subtitles,
                                                  description)
values (1, 9.70, 146, 'http://image.com/256x100.png/dddddd/000000', 86217.48, '2018-02-04', 1,
       ...
       (300, 2.20, 148, 'http://image.com/744x100.png/ff4444/ffffff', 160273.06, '2011-05-25', 0,
        'Duis ac nibh. Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus.');
insert into softuni_imdbs.movies (title, country_id, movie_info_id)
values ('Lumiere and Company (Lumière et compagnie)', 21, 1),
       ...
       ('Cleanskin', 44, 299),
       ('Bad Company', 44, 300);
insert into softuni_imdbs.movies_actors (movie_id, actor_id)
values (216, 15),
       (185, 28),
       (187, 56),
       (293, 132),
       ...
       (213, 146),
       (140, 137);
insert into softuni_imdbs.genres_movies (genre_id, movie_id)
values (6, 295),
       (21, 219),
       (20, 33),
       (8, 86),
