insert into softuni_game_dev_branch.addresses (`name`)
...
insert into softuni_game_dev_branch.offices (workspace_capacity, website, address_id)
...
insert into softuni_game_dev_branch.employees (first_name, last_name, age, salary, job_title, happiness_level)
...
insert into softuni_game_dev_branch.teams (`name`, office_id, leader_id)
...
INSERT INTO softuni_game_dev_branch.`categories` (`name`)
VALUES ('Action'),
       ('Adventure'),
       ('MMORPG'),
       ('Simulation'),
...
insert into softuni_game_dev_branch.games (name, description, rating, budget, release_date, team_id)
values ('Latlux',
...
insert into softuni_game_dev_branch.games_categories (game_id, category_id)
values (50, 7),
       (24, 7),
       (42, 6),
       (12, 4),
